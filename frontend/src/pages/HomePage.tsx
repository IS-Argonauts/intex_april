...
const HomePage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const loadAll = async () => {
      const [likes, drama, action, horror, trending, critical, myList] =
        await Promise.all([
  ...
  return (
    <>
      ...
      <RecommenderCarousel
        ...
        recommenderType="user"
        moviesOverride={likesMovies}
      />
      <RecommenderCarousel
        title="Drama Movies For You"
        recommenderType="user"
        moviesOverride={dramaMovies}
      />
      <RecommenderCarousel
        title="Action Movies For You"
        recommenderType="user"
        moviesOverride={actionMovies}
      />
      <RecommenderCarousel
        title="Horror Movies For You"
        recommenderType="user"
        moviesOverride={horrorMovies}
      />
      <RecommenderCarousel
        title="Trending Now"
        recommenderType="item"
        moviesOverride={trendingMovies}
      />
      <RecommenderCarousel
        title="Critically Acclaimed"
        recommenderType="hybrid"
        moviesOverride={criticallyMovies}
      />
      <RecommenderCarousel
        title="Your List"
        recommenderType="user"
        moviesOverride={myListMovies}
      />
